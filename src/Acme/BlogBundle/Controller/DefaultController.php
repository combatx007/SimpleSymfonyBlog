...
class DefaultController extends Controller
{
    public function indexAction()
    {
        ...
        return $this->render('AcmeBlogBundle:Default:index.html.twig',array('posts' => $posts));
    }
    ...
    public function pageAction($id)
    {
        ...
        return $this->render('AcmeBlogBundle:Default:index.html.twig', array('posts' => $posts,'pages' => $count_pages,
        'id' => $id));
    }
}
